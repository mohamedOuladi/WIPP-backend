...
public class GenericDataRepositoryTest {
	...
	public void setUp() {
		...
		publicGenDataA = new GenericData("publicGenDataA", false);
		...
		publicGenDataB = new GenericData("publicGenDataB", false);
		...
		privateGenDataA = new GenericData("privateGenDataA", false);
		...
		privateGenDataB = new GenericData("privateGenDataB", false);
